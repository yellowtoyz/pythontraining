...
# function to reboot hosts
def rebootcmd(devicecmd):

    for ip in devicecmd.keys(): # looping through the dict
        print(f'{crayons.blue("Connecting to:")} {ip} . .. ... {crayons.red("REBOOTING NOW")}')
    return None
...
def main():
    ...
    print()
    rebootcmd(devicecmd) # call function to reboot systems
